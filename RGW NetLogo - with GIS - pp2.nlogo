...
to load_world
  ...
  ;; Correcting error where all patches in top row have 0 flow - taking flow of southern neighbor
  if pycor = 381 [
    set flow [ flow ] of patch-at-heading-and-distance 180 1
  ]
...
to build_bridge
  if land_bridge = true [
   ask (patch-set
      ;; two patch wide bridge - 22, 59 to 27, 57
      patch 22 59 patch 23 59 patch 24 58 patch 25 58 patch 26 57 patch 27 57
      patch 21 59 patch 22 58 patch 23 58 patch 24 57 patch 25 57 patch 26 56
      patch 20 58 patch 21 58 patch 22 57 patch 23 57 patch 24 56 patch 25 56
      )  [
      set pcolor 74
      set resistance 0
...
to init_goats
  ...
  create-goats number [
    ...
    while [ [ flow ] of patch-here < random 1000 or pycor > 41 or pxcor < 28 ] [ setxy random-xcor random-ycor  ]
    set leader true
    set crossed false
